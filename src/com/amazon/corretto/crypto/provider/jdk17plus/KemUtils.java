...
public final class KemUtils {
    ...
    public static int getPublicKeySize(int parameterSet) {
        switch (parameterSet) {
            case MLKEM_512: return MLKEM512_PUBLIC_KEY_BYTES;
            case MLKEM_768: return MLKEM768_PUBLIC_KEY_BYTES;
    ...
    public static int getPrivateKeySize(int parameterSet) {
        switch (parameterSet) {
            case MLKEM_512: return MLKEM512_SECRET_KEY_BYTES;
            case MLKEM_768: return MLKEM768_SECRET_KEY_BYTES;
            case MLKEM_1024: return MLKEM1024_SECRET_KEY_BYTES;
            default: throw new IllegalArgumentException("Invalid parameter set: " + parameterSet);
        }
    }
    ...
    public static int getCiphertextSize(int parameterSet) {
        switch (parameterSet) {
            case MLKEM_512: return MLKEM512_CIPHERTEXT_BYTES;
            case MLKEM_768: return MLKEM768_CIPHERTEXT_BYTES;
            case MLKEM_1024: return MLKEM1024_CIPHERTEXT_BYTES;
            default: throw new IllegalArgumentException("Invalid parameter set: " + parameterSet);
        }
    }
